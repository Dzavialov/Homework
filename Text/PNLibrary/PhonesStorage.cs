...
namespace Text
{
    ...
    {
        private readonly string DbFilePath = @"C:\PhoneDbFolder\phonedb.txt";
        ...
        public void Search(string searchString)
        {
            var searchRecords = GetAllRecord()
                ...
                .Where(entity =>
                    entity != null && (entity.FirstName.Equals(searchString, StringComparison.OrdinalIgnoreCase)
                    || entity.LastName.Equals(searchString, StringComparison.OrdinalIgnoreCase)
                    || entity.PhoneNumber.Equals(searchString, StringComparison.OrdinalIgnoreCase)))
                .ToList();
